(function (translator) {
	translator.translations["es"] = {
		...
		"paperlabelbitcoinaddress": "Dirección Dash:",
		...
		"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus Dash.",
		...
		"vanityalertinvalidinputcannotmultiple": "Entrada no válida. No se puede multiplicar dos claves públicas. Seleccione 'Añadir' para agregar dos claves públicas para obtener una dirección Dash.",
		...
		"tagline": "Generador de carteras Dash de código abierto en lado de cliente con Javascript",
		"generatelabelbitcoinaddress": "Generando dirección Dash...",
		...
		"singlelabelbitcoinaddress": "Dirección Dash",
		...
		"brainlabelbitcoinaddress": "Dirección Dash:",
		...
		"vanitylabelbitcoinaddress": "Dirección Dash personalizada:",
		...
		"detaillabelnote2": "Dash v0.6+ almacena las claves públicas comprimidas. El cliente también soporta importar/exportar claves privadas usando importprivkey/dumpprivkey. El formato de las claves privadas exportadas depende de si la dirección se generó en una cartera antigua o nueva.",
		"detaillabelbitcoinaddress": "Dirección Dash:",
		"detaillabelbitcoinaddresscomp": "Dirección Dash (comprimida):",
